    ...
    <body id="page-top">
        ...
        <header class="masthead bg-primary text-white text-center">
            <div class="container d-flex align-items-center flex-column">
                ...
                <div class="content-center">
                  <div class="cc-profile-image"><a href="#"><img src="assets/img/anthony.jpg" alt="Image"/></a></div>
                 
                </div>
              </div>
                <!-- Masthead Heading-->
                <h1 class="masthead-heading text-uppercase mb-0">Marco Andrade</h1>
                <!-- Icon Divider-->
                ...
                <!-- Masthead Subheading-->
                <p class="masthead-subheading font-weight-light mb-0">Diseñador Web - Programador - Facilitador Online</p>
        ...
        <section class="page-section bg-primary text-white mb-0" id="about">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-4 ms-auto"><p class="lead">La filosofía que nos motiva en nuestro trabajo es ayudar a las empresas a solucionar sus problemas a través del Diseño Web, Desarrollo Web, Materiales Didácticos Multimedia, Soporte Técnico, Publicidad Empresarial y Marketing.</p></div>
                    <div class="col-lg-4 me-auto"><p class="lead">En el mundo de la informática los cambios son contantes, acelerados y con mucho enfoque innovador, por tal razón nuestro primer paso es cambiar nosotros mismos para luego convencer a otro de que los cambios son favorables partimos de experiencias vividas.</p></div>
                </div>
